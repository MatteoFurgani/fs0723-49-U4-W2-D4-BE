...
public class Application {
    public static void main(String[] args) {
        ...
        Order order1 = new Order(1L, "In attesa", LocalDate.of(2024,3,13), LocalDate.of(2024,5,12), List.of(product1, product2), customer1);
        Order order2 = new Order(2L, "In lavorazione", LocalDate.of(2024,3,14), LocalDate.of(2024,4,2), List.of(product3, product4), customer2);
        Order order3 = new Order(3L, "Spedito", LocalDate.of(2024,3,10), LocalDate.of(2024,3,15), List.of(product5, product6), customer3);
        Order order4 = new Order(4L, "Consegnato", LocalDate.of(2024,2,5), LocalDate.of(2024,2,10), List.of(product7, product8), customer4);
        Order order5 = new Order(5L, "Consegnato", LocalDate.of(2024,2,29), LocalDate.of(2024,3,6), List.of(product9, product10), customer5);
